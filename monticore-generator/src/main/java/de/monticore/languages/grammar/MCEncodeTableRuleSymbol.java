 ...
 *
 */
public class MCEncodeTableRuleSymbol extends MCRuleSymbol {

  private Optional<ASTEncodeTableProd> ruleNode;
  
  public MCEncodeTableRuleSymbol(ASTEncodeTableProd rule) {
    super(rule.getName());
    this.ruleNode = Optional.of(rule);
  }

  protected MCEncodeTableRuleSymbol(String name) {
   super(name);
  }
  ...
  public KindSymbolRule getKindSymbolRule() {
    return KindSymbolRule.ENCODETABLERULE;
  }
   ...
   */
  public Optional<ASTEncodeTableProd> getRuleNode() {
