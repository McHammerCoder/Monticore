 ...
 *
 */
public class MCBinaryRuleSymbol extends MCRuleSymbol {

  private Optional<ASTBinaryProd> ruleNode;
  
  public MCBinaryRuleSymbol(ASTBinaryProd rule) {
    super(rule.getName());
    this.ruleNode = Optional.of(rule);
  }

  protected MCBinaryRuleSymbol(String name) {
   super(name);
  }
  ...
  public KindSymbolRule getKindSymbolRule() {
    return KindSymbolRule.BINARYRULE;
  }
   ...
   */
  public Optional<ASTBinaryProd> getRuleNode() {
