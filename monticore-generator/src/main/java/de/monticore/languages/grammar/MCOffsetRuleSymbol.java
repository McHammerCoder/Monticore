 ...
 *
 */
public class MCOffsetRuleSymbol extends MCRuleSymbol {

  private Optional<ASTOffsetProd> ruleNode;
  
  public MCOffsetRuleSymbol(ASTOffsetProd rule) {
    super(rule.getName());
    this.ruleNode = Optional.of(rule);
  }

  protected MCOffsetRuleSymbol(String name) {
   super(name);
  }
  ...
  public KindSymbolRule getKindSymbolRule() {
    return KindSymbolRule.OFFSETRULE;
  }
   ...
   */
  public Optional<ASTOffsetProd> getRuleNode() {
